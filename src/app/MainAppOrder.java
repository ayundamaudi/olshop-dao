...
public class MainAppOrder {
  ...
  static OrderDetailDAO dao4 = new OrderDetailImpl(
...
private static void listProduct() throws Exception {
  ...
  private static void add(BufferedReader input) throws Exception {
    ...
    do {
      ...
      totalPriceForm += orderDetail.getProduct().getPrice() * orderDetail.getQtyProduct();

      System.out.println("tot sementara" + totalPriceForm);
      System.out.println("============================");
